...
import s5 from "../public/scenarios/tcu_secret_name.json";
import s6 from "../public/scenarios/tcu_union_and_disillusion.json";
import s7 from "../public/scenarios/tcu_wages_of_sin.json";
import s8 from "../public/scenarios/tcu_witching_hour.json";
...
export const SCENARIOS = {
  ...
  "tcu_secret_name": s5,
  "tcu_union_and_disillusion": s6,
  "tcu_wages_of_sin": s7,
  "tcu_witching_hour": s8,
} as const;
